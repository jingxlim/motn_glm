...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function onp_indiv(spikes_binned,vxN,vyN,phi,r)
% models tested
...
%     figs{m*i}   = figure('Name',['ONP: ' names{i} ' multimodal']);
    ...
    for j = 1:10
        figs{j,i,1} = figure();
        figs{j,i,2} = figure();
        test_mods(spikes_binned,params{i},names{i},m_names,j,i,m,figs);
    end
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function test_mods(spikes_binned,data,name,m_names,n,p,m,figs)
...
%     subplot(2,5,n)
    ...
    title(['Neuron ' num2str(n)]) % ', ' name ', ' m_names{i}])
    xlabel([name model{i}]);
...
set(gca,'fontsize',20)
saveas(gcf, ['ONP_' num2str(n) '_' name '_linear.png'])
...
set(gca,'fontsize',20)
saveas(gcf, ['ONP_' num2str(n) '_' name '_quad.png'])
